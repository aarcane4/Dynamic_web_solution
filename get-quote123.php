...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   //$sql = "INSERT INTO `quote_requests` (`name`, `email`, `phone_no`, `country`, `comment`) VALUES ($name,$email,$phone,$country,$comment)";
    ...
    // if (isset($_POST['quoteformwork']) && !empty($_POST['quoteformwork'])) {
    //     // Loop through each selected interest
    //     foreach ($_POST['quoteformwork'] as $interest) {
    //         // Process each interest here (you can insert them into a database, for example)
    //         echo "Selected interest: " . $interest . "<br>";
