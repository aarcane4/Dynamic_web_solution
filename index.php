                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="section-content-v pe-lg-5 pe-0">
                            ...
                            <p class="text-text">Every great business idea takes wings with the launch of a
                                professionally designed website and though Dynamic Web solutions was formed with the specific mission
                    ...
                    <div class="col-lg-6">
                         <div class="section-content-v">
                           <img src="assets\images\brand.jpg" width="600" height="298"
                             class="img-fluid mt-5 mt-lg-0"
                             srcset="assets\images\brand.jpg 600w, assets\images\brand.jpg 400w"
                            sizes="(min-width: 992px) 600px, 50vw" alt="Being Smart" />
                         </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <img src="assets\images\1.jpg" width="600" height="298"
                             class="img-fluid mt-5 mt-lg-0"
                             srcset="assets\images\1.jpg 600w, assets\images\1.jpg 400w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Keep things in proportion Dynamic4web" />
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                        <img src="assets\images\2.jpg" width="600" height="298"
                             class="img-fluid mt-5 mt-lg-0"
                             srcset="assets\images\2.jpg 600w, assets\images\2.jpg 400w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Put people first" />
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                        <img src="assets\images\3.jpg" width="600" height="298"
                             class="img-fluid mt-5 mt-lg-0"
                             srcset="assets\images\3.jpg 600w, assets\images\3.jpg 400w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Graphic Design" />
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                        <img src="assets\images\4.jpg" width="600" height="298"
                             class="img-fluid mt-5 mt-lg-0"
                             srcset="assets\images\4.jpg 600w, assets\images\4.jpg 400w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="See the bigger picture" />
                            <div class="overlay-02 overlay-dark"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                          <img src="assets\images\5.jpg" width="600" height="298"
                             class="img-fluid mt-5 mt-lg-0"
                             srcset="assets\images\5.jpg 600w, assets\images\5.jpg 400w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Think globally" />
                            <div class="overlay-02 overlay-yellow"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                    ...
                    <div class="col-lg-4">
                        <div class="img-overlay-02">
                        <img src="assets\images\6.jpg" width="600" height="298"
                             class="img-fluid mt-5 mt-lg-0"
                              srcset="assets\images\6.jpg 600w, assets\images\6.jpg 400w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Never stop learning" />
                            <div class="overlay-02 overlay-blue"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5 section-light">
                                ...
                                <p class="text-text py-4">Good client relations are crucial to us too. Although our
                                    experts are very technical, everyone at Dynamic web solutions knows how to translate expertise
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-lg-0 mb-5">
                        <div class="section-content-v">
                            ...
                            <p class="text-text pe-lg-5 pe-0">Dyanamic web solutions is a web design and system development company
                    ...
                    <div class="col-lg-12">
                        <div class="swiper-container homeswiper-02">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                   <img src="assets\images\11.png" class="img-fluid swipe-img-02" alt="Vue Js" />
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets\images\12.png" class="img-fluid swipe-img-02" alt="bootstrap" />
                                </div>

                                <div class="swiper-slide">
                                <img src="assets\images\13.png" class="img-fluid swipe-img-02" alt="Jquery" />
                                </div>

                                <div class="swiper-slide">
                                <img src="assets\images\14.png" class="img-fluid swipe-img-02" alt="Angular" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets\images\15.png" class="img-fluid swipe-img-02" alt="CSS3" />
                                </div>

                                <div class="swiper-slide">
                                <img src="assets\images\16.png" class="img-fluid swipe-img-02" alt="JAVA" />
                                </div>

                                <div class="swiper-slide">
                                <img src="assets\images\17.png" class="img-fluid swipe-img-02" alt="React" />
                                </div>

                                <div class="swiper-slide">
                                <img src="assets\images\18.png" class="img-fluid swipe-img-02" alt="HTML5" />
                                </div>
